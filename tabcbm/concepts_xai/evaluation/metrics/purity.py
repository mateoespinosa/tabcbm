"""
Adaped from https://github.com/dmitrykazhdan/concept-based-xai.

All credit due to Kazhdan et al. (arXiv:2104.06917) and
Espinosa Zarlenta et al. (AAAI, 2023)
"""
...
def concept_purity_matrix(
    ...
    if isinstance(c_soft, np.ndarray):
        ...
        if concept_label_cardinality is None:
            concept_label_cardinality = [2 for _ in range(n_true_concepts)]
        ...
        if concept_label_cardinality is None:
            concept_label_cardinality = [None for _ in range(n_true_concepts)]
