...
from local_pytorch_tabnet import tab_network
from local_pytorch_tabnet.utils import (
...
from local_pytorch_tabnet.pretraining_utils import (
    create_dataloaders,
    validate_eval_set,
)
from local_pytorch_tabnet.metrics import (
    UnsupMetricContainer,
    check_metrics,
    UnsupervisedLoss,
)
from local_pytorch_tabnet.abstract_model import TabModel
...
class TabNetPretrainer(TabModel):
    ...
    def _predict_batch(self, X):
        ...
        print("self.network.device =", self.network.device)
        return self.network(X)

    def stack_batches(self, list_output, list_embedded_x, list_obfuscation):
        print("list_output =", list_output)
        print("list_embedded_x =", list_embedded_x)
        print("list_obfuscation =", list_obfuscation)
